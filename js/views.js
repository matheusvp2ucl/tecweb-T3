function PegaTabelinha(produto){
    aux = `<tr>
        ...
        <td class="btnSpac">
            <button onclick="cProduto.editarProduto(${produto.codigo})" class="btn btn-outline-success btnSpac"><i class="bi bi-pen-fill"></i></button>
            <button onclick="cProduto.excluirProduto(${produto.codigo})" class="btn btn-outline-danger btnSpac"><i class="bi bi-x"></i></button>
        </td>
    </tr>\n`;
    return aux;
}
